...
public class EmployeeApp extends Employee{
	...
	public static void main(String[] args) {
		...
		while(true)
		{
			...
			if(MenuNum==1) // Display Employee's Information 메뉴 
			{
			...
			else if(MenuNum==2) // Change Employee's Position 메뉴 
			{
				for(i=0;i<employee.length;i++)
				{
					employee[i].printEmployeePositionInfo(i); // 전체 이름, 직위(position)정보를 화면에 출력
				}
				...
				while(true)
				{
					...
					{	
						...
						System.out.println("------------------------------------------------------");
						employee[num2Index-1].printEmployeePositionInfo(num2Index-1); // 변경된 내용을 화면에 출력
						System.out.println("------------------------------------------------------");
						System.out.println("");
					...
					{
						System.out.println("Wrong index. Type again"); //  index값이 배열의 범위를 넘어가면 다시 입력 받음 
					}
				}
			}
			else if(MenuNum==3) // Change Employee's Salary 메뉴 
			{
				for(i=0;i<employee.length;i++)
				{
					employee[i].printEmployeeSalaryInfo(i); // // 전체 이름, 월급(salary)정보를 화면에 출력
				}
				...
				while(true)
				{
					...
					{	
						...
						System.out.println("------------------------------------------------------");
						employee[num3Index-1].printEmployeeSalaryInfo(num3Index-1);  //변경된 내용을 화면에 출력
						System.out.println("------------------------------------------------------");
						System.out.println("");
